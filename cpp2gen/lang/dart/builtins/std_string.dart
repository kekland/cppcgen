...
extension _std_string_ext on gen_ffi.std_string_t {
  String toDart() {
...
extension _std_string_ref_ext on gen_ffi.std_string_ref_t {
...
extension _StringFfiExt on String {
  gen_ffi.std_string_ref_t toFfi({Arena? arena}) => _std_string_ref_ext.fromDart(this, arena: arena);
