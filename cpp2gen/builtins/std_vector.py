...
@dataclass
class StdVectorTemplate(BuiltinTemplate):
  @property
  def arg(self) -> Type: return self.type_.template_args[0]  # type: ignore
  ...
  @property
  def base_name_impl(self) -> str: return f'std_vector_{self.arg.base_name.lower()}'
