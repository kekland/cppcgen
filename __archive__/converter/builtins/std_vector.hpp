...
FFI void std_vector_ARG1_resize(std_vector_ARG1_t instance, size_t new_size);
...
FFI void std_vector_ARG1_push_back(std_vector_ARG1_t instance, ARG1_C_PTR value);
...
FFI void std_vector_ARG1_push_back(std_vector_ARG1_t instance, ARG1_C_PTR value) {
  FFI_FUNCTION_GUARD_BEGIN
  auto instance_ = std_vector_ARG1::unwrap(instance);
  instance_->push_back(CAST1_TO_CPP(value));
  FFI_FUNCTION_GUARD_END()
}
